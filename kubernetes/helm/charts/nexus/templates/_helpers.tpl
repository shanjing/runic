...
{{- printf "postgresql://%s:%s@%s:%s/%s" .Values.secrets.database.user .Values.secrets.database.password .Values.secrets.database.host .Values.secrets.database.port .Values.secrets.database.name }}
{{- end }}
...
{{- default "coordination-system" .Release.Namespace }}
{{- end }}
